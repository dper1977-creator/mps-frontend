document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderRelawanTable(data) {
        ...
        data.forEach(relawan => {
            ...
            row.innerHTML = `
                ...
                <td>${relawan.no_id}</td>
                <td>${relawan.no_hp_relawan || '-'}</td>
                <td>${relawan.alamat_relawan || '-'}</td>
                <td>${relawan.keterangan || '-'}</td>
                <td>
                    <button class="btn edit" data-id="${relawan.id_relawan}">
                        <i class="fas fa-edit"></i>
                    </button>
                    <button class="btn danger" data-id="${relawan.id_relawan}">
    ...
    function renderTeamTable(teams) {
        ...
        teams.forEach(team => {
            ...
            row.innerHTML = `
                <td>${team.tim}</td>
                <td>${team.jumlah_relawan}</td>
                <td>${team.daftar_relawan}</td>
            `;
